...
const GanttChartWBSCard = () => {
  return (
    <a href="https://v0-kirii-project-gantt-chart.vercel.app/" target="_blank" rel="noopener noreferrer" className="block w-full">
      <div className="w-full md:w-[420px] relative p-4 rounded-xl bg-[#f1f1f3] shadow-sm cursor-pointer transition-all hover:shadow-md">
        <h3 className="text-xl font-bold hover:text-[#02315a] hover:underline transition-colors">Gantt Chart & WBS</h3>
        <p className="text-[#3c3852] text-sm mt-4">銷售進度管理系統</p>
...
export default GanttChartWBSCard; 